<%@ Page Title="" Language="C#" MasterPageFile="~/Deals/DealPage.master" AutoEventWireup="true" CodeFile="exclusive_deals_to_lasvegas.aspx.cs" Inherits="Deals_exclusive_deals_to_lasvegas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tr>
    ...
    <td height="25" align="left" valign="middle" background="../images/Holidays/blue-gre.gif" class="whiteboldtext">Flights To Las Vegas</td>
    <td width="10" height="10" align="left" valign="top"></td>
  </tr>
  <tr>
      ...
      <tr>
          ...
          <tr>
            <td width="730" height="100" align="left" valign="top">        
             ...
             <table class="auto-style3">
                ...
                <asp:SqlDataSource ID="SqlDataSource1" runat="server"  ConnectionString="<%$ ConnectionStrings:TheUKflightsConnectionString %>" SelectCommand="SELECT * FROM [Flights to Lagos]"></asp:SqlDataSource>
              </td>
          </tr>
          <tr>
            <td width="730" height="10" align="left" valign="top"></td>
        ...
        <td width="238" height="10" align="left" valign="top"><table width="238" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td colspan="2" align="left" valign="middle" bgcolor="e9f5fe" class="h1">More Destinations in Las Vegas</td>
