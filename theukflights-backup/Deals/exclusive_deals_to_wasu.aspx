<%@ Page Title="" Language="C#" MasterPageFile="~/Deals/DealPage.master" AutoEventWireup="true" CodeFile="exclusive_deals_to_wasu.aspx.cs" Inherits="Deals_exclusive_deals_to_wasu" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <tr>
    ...
    <td height="25" align="left" valign="middle" background="../images/Holidays/blue-gre.gif" class="whiteboldtext">Flights To Wasu</td>
    <td width="10" height="10" align="left" valign="top"></td>
  </tr>
  <tr>
      ...
      <tr>
        ...
        <td width="238" height="10" align="left" valign="top"><table width="238" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            ...
            <td colspan="2" align="left" valign="middle" bgcolor="e9f5fe" class="h1">More Destinations in Wasu</td>
