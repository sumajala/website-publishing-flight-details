...
public partial class Bookflights : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
            ...
            for (int i = 0; i < Convert.ToInt32(Literal1.Text); i++)
            {
            ...
            if (lbl_bookRef!=null )
            {
                ...
                using (SqlConnection con = new SqlConnection(constr))
                {
                    using (SqlCommand cmd = new SqlCommand("INSERT INTO pax_personinfo (BookReferenceID,Title,FirstName,SurName,DateofBirth,Sex,PaxType) VALUES(@BookReferenceID,@Title,@FirstName,@SurName,@DateofBirth,@Sex,@PaxType)"))
                    {
                        ...
                        cmd.Parameters.AddWithValue("@Title",dbtitle.SelectedValue.ToString());
                        ...
                        cmd.Parameters.AddWithValue("@Sex",dbsex.SelectedValue.ToString());
